...
all_players = json.load(open('raw/2015/2015_get_res_data_list.json'))["players"]
...
def persist_player_stats(stats):
    c = conn.cursor()
    data = [stats['id'], stats['firstname'], stats['bat_points'], stats['bol_points'], stats['field_points'], stats['bonus_points'], stats['fanta_points'], 2015]
